...
class productClass:
    def __init__(self,root):
        ...
        lbl_stock= Label(self.root, text="Stock:", font =("goudy old style", 18), bg="white").place(x=600, y =118)#gggggg
        lbl_fecha_ingreso= Label(self.root, text="Fecha_Ingreso:", font =("goudy old style", 18), bg="white").place(x=790, y =118)
        ...
        txt_stock= Entry(self.root, textvariable=self.var_stock, font =("goudy old style", 18), bg="white").place(x=680, y =120, width=80)
        txt_fecha_ingreso= Entry(self.root, textvariable=self.var_fecha_ingreso, font =("goudy old style", 18), bg="white").place(x=950, y =120, width=100)
    ...
    def agregar_producto(self):
        ...
        producto = ProductoDB(self.var_name.get(),  
                                self.var_desc.get(), 
                                self.var_precio.get(),
                                self.var_id_proveedor.get(),
                                self.var_id_categoria.get(),
                                self.var_stock.get(),
                                self.var_fecha_ingreso.get())
