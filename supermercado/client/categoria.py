...
class categoryClass:
    def __init__(self,root):
        ...
        #=====title===
        lbl_title= Label(self.root, text="Market Manager Categoría", font =("goudy old style", 30), bg="#184a45", fg="white", bd=3, relief=RIDGE).pack(side=TOP, fill=X)
        lbl_name= Label(self.root, text="Nombre:", font =("goudy old style", 18), bg="white").place(x=50, y =118)
        lbl_description= Label(self.root, text="Descripción:", font =("goudy old style", 18), bg="white").place(x=50, y =198)
